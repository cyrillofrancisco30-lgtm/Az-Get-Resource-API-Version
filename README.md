...
CSV existente
    ≠
CSV produzido pela execução alegada


CSV íntegro
    ≠
CSV semanticamente correto

response_hash válido
    ≠
response proveniente da API alegada
...
ARTIFACT_IDENTITY              = SUPPORTED
DECLARATION_SUPPORTED          = YES

PIPELINE_DEFINITION            = SUPPORTED
PIPELINE_EXECUTION             = NOT_ESTABLISHED

AUTHENTICATION                 = NOT_OBSERVED
REPOSITORY_CHECKOUT            = NOT_OBSERVED
AZURE_API_REQUEST              = NOT_OBSERVED
AZURE_API_RESPONSE             = NOT_OBSERVED
COMPARISON_EXECUTION           = NOT_OBSERVED
CSV_PRODUCTION                 = NOT_ESTABLISHED
CSV_EXECUTION_BINDING          = NOT_ESTABLISHED

INDEPENDENT_VERIFICATION       = NOT_PERFORMED

EXECUTION_NOT_ESTABLISHED
RESULT_NOT_ESTABLISHED
VERIFIED_NOT_PROMOTABLE
